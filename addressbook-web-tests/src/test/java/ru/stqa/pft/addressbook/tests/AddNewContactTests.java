...
public class AddNewContactTests {
    ...
    public void testAddNewContact() {
        gotoAddContactPage();
        initContactCreation();
        addNewContact(new NewContactData("Sergey", "Kharkovshchenko", "kharkovchenko@gmail.com"));
        returnToAddContactPage();
    }

    private void returnToAddContactPage() {
    ...
    private void addNewContact(NewContactData newContactData) {
